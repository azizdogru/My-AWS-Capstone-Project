...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cl17m16gjspq.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstones-aziz-blog' # please enter your s3 bucket name
